...
def lee_poblaciones(ruta_fichero):
    ...
    with open(ruta_fichero,"rt", encoding="utf-8") as f:
        ...
        for r in lector:
            r[2]=int(r[2])
            r[3]=int(r[3])
            res.append(RegistroPoblacion(r[0],r[1],r[2],r[3]))
    return res
...
def calcula_paises(poblaciones):
    ...
    @rtype: list(str)
    """
    conjunto_paises={r.pais for r in poblaciones}
...
def filtra_por_pais(poblaciones, pais_o_codigo):
    ...
    """
    return [(r.año, r.censo) for r in poblaciones if r.pais==pais_o_codigo or r.codigo==pais_o_codigo]
